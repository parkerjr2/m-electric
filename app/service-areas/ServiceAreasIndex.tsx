    ...
    <main className="bg-black text-white">
      ...
      <section className="relative overflow-hidden border-b border-neutral-900">
        ...
        <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-24 sm:py-32 text-center">
          ...
          >
            {linkify(
              "M Electric serves the entire greater Tulsa metro — 11 cities, every zip code in Tulsa, plus Broken Arrow, Owasso, Bixby, Jenks, Sapulpa, Sand Springs, Berryhill, Turley, Oakhurst, and Glenpool. Licensed, bonded, insured. No travel surcharge anywhere in the metro.",
      ...
      <section className="mx-auto max-w-4xl px-4 sm:px-6 py-20 sm:py-24">
        ...
        <p className="mt-8 text-neutral-300 text-lg leading-relaxed">
          {linkify(
            "M Electric is owned and operated by US Army veteran Marshall Morgan, who founded the company in 1999. We cover an 11-city service area. That area includes every Tulsa neighborhood plus all of the surrounding metro. Our base of operations is inside Tulsa city limits, which keeps response times tight. Inside the loop, emergencies are typically reached in under 60 minutes. Broken Arrow, Owasso, Bixby, and Jenks are 60–90 minutes. Sapulpa, Sand Springs, Glenpool, and the smaller unincorporated communities of Berryhill, Turley, and Oakhurst are 60–120 minutes. We do not charge a travel surcharge anywhere in our standard service area. Rates in Glenpool match rates in Tulsa, and the same crew handles every job.",
            { currentPath: "/service-areas" }
          )}
        </p>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-20 sm:py-28 text-center">
          ...
          <p className="mt-5 text-white/90 text-lg max-w-xl mx-auto">
            ...
            service available across all 11 service areas.
          </p>
